...
# 创建标签
tkinter.Label(frame_t, text='直播播间地址:https://live.bilibili.com/', width=30, font=('Arial', 10)).pack(side=tkinter.LEFT)
# 显示成明文形式
default_text = tkinter.StringVar()
default_text.set("22445644")
...
# 创建并放置两个按钮分别触发两种情况
b1 = tkinter.Button(frame_t, text='连接', width=10, command=start_point, font=('Arial', 10))
b1.pack(side=tkinter.LEFT)
b2 = tkinter.Button(frame_t, text='断开', width=10, command=end_point, font=('Arial', 10))
